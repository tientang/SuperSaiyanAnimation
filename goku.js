class Goku {
    constructor(game) {
        ...
        this.animations.push(new Animator(this.spritesheet, 57, 422, 48.875, 75, 5, 0.086, 3.5, false, true));
    };
    ...
    draw(ctx) {
        this.animations[0].drawFrame(this.game.clockTick, ctx, 300, 175, 6);
    };
}
