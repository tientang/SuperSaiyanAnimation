class Goku {
    constructor(game) {
        ...
        this.animations.push(new Animator(this.spritesheet, 57, 422, 48.875, 60, 5, 0.0875, 3.5, false, true));
    };
    ...
    draw(ctx) {
        this.animations[0].drawFrame(this.game.clockTick, ctx, 185, 175, 6);
    };
}
